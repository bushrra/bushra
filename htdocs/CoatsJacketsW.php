...
<html>
	<head>
		...
		<title>Women | Coats And Jackets</title>
		<meta charset="UTF-8">
	</head>
	<body>
		...
		<div class="container">
		 <h3>Women | Coats And Jackets</h3>
		</div>
		
			<div class="ProductList" style="display: flow-root;">
			 
			<?php
				$query = "SELECT * FROM ssubcategory where (typeID=1 and subcatID=2) or (typeID=1 and subcatID=3)";
