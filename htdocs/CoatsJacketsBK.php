...
<html>
	<head>
		...
		<title>Big Kids | Coats And Jackets</title>
		<meta charset="UTF-8">
	</head>
	<body>
		...
		<div class="container">
		 <h3>Big Kids | Coats And Jackets</h3>
		</div>
		
			<div class="ProductList" style="display: flow-root;">
			 
			<?php
			$query = "SELECT * FROM ssubcategory where (typeID=3 and subcatID=2) or (typeID=3 and subcatID=3)";
